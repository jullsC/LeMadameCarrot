        ...
        <form action="editardatos.php" method="post">
           ...
           <form action="cambiarpass.php" method="post">
               ...
               <div class="row">
                   ...
                   <div class="col-md-6"><input class="form-control" type="password" required id='passold' name='passold'></div>
                   <div class="col-md-2 col-md-offset-2"></div>
               </div>
               <div class="row">
                   <div class="col-md-2 col-md-offset-2"></div>
                   <div class="col-md-2 col-form-label"><label>Contraseña Nueva</label></div>
                   <div class="col-md-6"><input class="form-control" type="password" required id='passnew' name='passnew'></div>
                   <div class="col-md-2 col-md-offset-2"></div>
               </div>
               <div class="row">
